...
if ($conn->connect_error){
	...
	$sql="INSERT INTO teacher_reservation (name,department,organization,eventname,purpose,date,time)
			VALUES('$name','$department','$organization','$eventname','$purpose', '$date','$time')";
			if ($conn->query($sql)===TRUE) {
            }else{
		$_SESSION['msg']="Request Reservation Successfully";
	}
$conn->close();
?>
         ...
         <h2>RESERVATION FORM</h2>
             ...
             <center>
                <div id="nav">
                        ...
                        <input type="text" name="name" placeholder="Teacher Name" autofocus required = ""> <br>
